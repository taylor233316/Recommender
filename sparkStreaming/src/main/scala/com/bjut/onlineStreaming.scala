...
object ConnHelper extends Serializable{
  lazy val jedis = new Jedis("62.234.220.250", 6379)
  lazy val mongoClient = MongoClient( MongoClientURI("mongodb://root:123456@62.234.220.250:27017/recommender") )
}
...
object onlineStreaming {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val ssc = new StreamingContext(sc, Seconds(10))    // batch duration
    ...
    // 定义kafka连接参数
    val kafkaParam = Map(
      "bootstrap.servers" -> "62.234.220.250:9092",
      "key.deserializer" -> classOf[StringDeserializer],
      "value.deserializer" -> classOf[StringDeserializer],
      "group.id" -> "recommender1",
